...
### If you need to track more than one spell then make a copy fo this file,rename it and set the options. For example rename to Pyina_Fear.py
### When program opens right click and set to Stay on Top if you like.
### It has a few bugs but it works pretty good. I am by no means a master coder! One day it will track more than one spell at a time!
